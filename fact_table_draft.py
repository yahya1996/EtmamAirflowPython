...
url = 'https://etmam-services.housing.gov.sa/ar/user/fact-app-draft?data=all'
"""
db = mysql.connect(
   host="10.0.4.2",
  user="airflow_us",
...
def save_fact_data(data,today,dt_string):
    for fact_data in data:
        ...
        sql = "INSERT INTO Fact_applications_draft (nid,application_id,service_id,service_name,region,city,created_date)  VALUES (%s,%s,%s,%s,%s,%s,%s)"
        val = (nid ,application_id,service_type,service_name,region,city,create_date)
